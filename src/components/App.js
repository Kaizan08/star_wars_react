...
class App extends Component {
  ...
  handleNameChange = event => {
    let tempPilot = event.target.value;
  ...
  render() {
    ...
    */
    ...
    return (
      <div className="App">
        <Jumbotron />
        <Form pilot={this.state.pilot} tempPilot={this.state.tempPilot} inputAction={this.handleNameChange} setPilot={this.handleSubmit}/>
